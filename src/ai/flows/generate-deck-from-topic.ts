...
const GenerateDeckFromTopicOutputSchema = z.object({
  cards: z.array(z.object({
    question: z.string().describe('The question for the flashcard. This should be a clear, concise question covering a key concept of the topic.'),
    answer: z.string().describe('The answer for the flashcard. This should be a detailed and accurate answer to the question, suitable for learning.'),
  })).describe('An array of generated flashcards, between 10 and 20 cards long.'),
});
